                    ...
                    <div className="proj-screen">
                        <div className="proj-wrap">
                            <div className="side-text">
                                <p className="top">혼자서 만들어본 리액트 프로젝트<br/>마우스를 올리면 프로젝트 관련 설명과<br className="mobile" /> 깃허브/홈페이지 이동 버튼이 있습니다.</p>
                    ...
                    <div className="proj-screen">
                        <div className="proj-wrap">
                            ...
                            <div className="hover-cont">
                                ...
                                <ul className="btns">
                                    <li><a href="https://github.com/1bins/haru-diary" target="_blank" title="새 창으로 열기" rel="noreferrer">깃허브 바로가기</a></li>
                                    <li><a href="#" onClick={() => {window.open('https://wonbin-haru-diary-project.web.app/', '_blank', 'width=400, height=800')}} target="_blank" title="새 창으로 열기" rel="noreferrer">사이트 바로가기</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="proj-screen">
                        <div className="proj-wrap">
                            ...
                            <div className="hover-cont">
                                ...
                                <ul className="btns">
                                    <li><a href="https://github.com/1bins/momentum-react" target="_blank" title="새 창으로 열기" rel="noreferrer">깃허브 바로가기</a></li>
                                    <li><a href="https://wonbin-momentum-project.web.app/" target="_blank" title="새 창으로 열기" rel="noreferrer">사이트 바로가기</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="proj-screen">
                        <div className="proj-wrap">
                            ...
                            <div className="hover-cont">
                                ...
                                <ul className="btns">
                                    <li><a href="https://github.com/1bins/catjjal-maker" target="_blank" title="새 창으로 열기" rel="noreferrer">깃허브 바로가기</a></li>
                                    <li><a href="https://1bins.github.io/catjjal-maker/" target="_blank" title="새 창으로 열기" rel="noreferrer">사이트 바로가기</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
